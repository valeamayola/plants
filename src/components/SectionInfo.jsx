...
export function SectionInfo () {
    ...
    return (
        <>
        <h1 id="plants" className="font-bold mt-20 text-center text-2xl">Conocé diferentes tipos de plantas y sus cuidados</h1>
        <header className="mt-10 md:mt-5 md:px-20">
        <h1 className="font-bold text-2xl mb-5 px-5 md:px-0">Plantas de interior</h1>
        </header>
        <section className="flex md:flex-row flex-col md:mb-5 mb-0 md:px-10 justify-center">
        ...
        <section className="flex md:flex-row flex-col mb-16 md:px-10 justify-center">
        ...
        <section className="flex md:flex-row flex-col mb-10 md:px-10 justify-center">
